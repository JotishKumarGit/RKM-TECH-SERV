...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <section class="hero-section">
        <div class="container">
            <h1 class="animated-gradient-text" data-aos="fade-down" data-aos-duration="1500">
                RKM TECH SERV
            </h1>
    ...
    <!-- products sections  -->
    <div class="container-fluid" style="padding: 60px 0; background-color: #201a74;">
        <div class="container">
            <!-- Section Heading -->
            <div class="text-center mb-5">
                <h2 style="color: #0B5ED7; font-weight: bold;">Our Products</h2>
                <p style="color: #6c757d; font-size: 18px;">
                    Explore our range of high-quality electronic products designed for modern lifestyles.
                </p>
            </div>
            ...
            <div class="row justify-content-center g-4">
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        ...
                        <img src="assets/images/Batteries.jpg" class="card-img-top" alt="Batteries"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Batteries</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Reliable and long-lasting batteries for mobile phones and electronic devices.
                            </p>
                            <a href="batteries.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Video_Walls.jpg" class="card-img-top" alt="Video Walls"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Video Walls</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                High-definition video walls for commercial displays and digital signage.
                            </p>
                            <a href="video_walls.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Tube_Lights.jpg" class="card-img-top" alt="Tube Lights"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Tube Lights</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Energy-efficient tube lights for home, office and industrial lighting.
                            </p>
                            <a href="tube_lights.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/tablets.jpg" class="card-img-top" alt="Tablets"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Tablets</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Latest tablets with powerful processors and vibrant displays for work or entertainment.
                            </p>
                            <a href="tablets.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Switches_Sockets.jpg" class="card-img-top" alt="Switches & Sockets"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Switches & Sockets</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                High-quality electrical switches and sockets designed for safety and durability.
                            </p>
                            <a href="switches_sockets.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Smartphones.jpeg" class="card-img-top" alt="Smartphones"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Smartphones</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Latest smartphones with advanced camera systems and smooth performance.
                            </p>
                            <a href="smartphones.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/smart_watch.jpeg" class="card-img-top" alt="Smart Watch"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Smart Watches</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Stylish smartwatches with health tracking and connectivity features.
                            </p>
                            <a href="smart_watch.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Personal_Gifts.webp" class="card-img-top" alt="Personal Gifts"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Personal Gifts</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Unique personalized gifts perfect for birthdays, anniversaries and celebrations.
                            </p>
                            <a href="personal_gifts.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/makhana.jpeg" class="card-img-top" alt="Makhana"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Makhana</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Healthy and crunchy makhana snacks packed with nutrition and taste.
                            </p>
                            <a href="makhana.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/LED_Bulbs.jpg" class="card-img-top" alt="LED Bulbs"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">LED Bulbs</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Bright, long-lasting and energy-saving LED bulbs for every lighting need.
                            </p>
                            <a href="led_bulbs.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Keypad_Phones.jpeg" class="card-img-top" alt="Keypad Phones"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Keypad Phones</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Durable keypad phones with strong battery life and essential features.
                            </p>
                            <a href="keypad_phones.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Interactive_Displays.webp" class="card-img-top"
                            alt="Interactive Displays" style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Interactive Displays</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Smart interactive displays ideal for classrooms, meetings and presentations.
                            </p>
                            <a href="interactive_displays.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Fluorescent_Lights.webp" class="card-img-top" alt="Fluorescent Lights"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Fluorescent Lights</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Bright fluorescent lamps providing efficient lighting for large spaces.
                            </p>
                            <a href="fluorescent_lights.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Fibre_Optic_Cables.jpg" class="card-img-top" alt="Fibre Optic Cables"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Fibre Optic Cables</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                High-speed fibre optic cables for ultra-fast internet and data transfer.
                            </p>
                            <a href="fibre_optic_cables.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Fans.jpg" class="card-img-top" alt="Fans"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Fans</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Energy-efficient ceiling and table fans providing powerful cooling.
                            </p>
                            <a href="fans.php" class="btn" style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Electric_Cables.jpg" class="card-img-top" alt="Electric Cables"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Electric Cables</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Safe and durable electric cables for wiring residential and commercial spaces.
                            </p>
                            <a href="electric_cables.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Decorative_Lights.jpg" class="card-img-top" alt="Decorative Lights"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Decorative Lights</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Beautiful decorative lighting to enhance homes, events and interiors.
                            </p>
                            <a href="decorative_lights.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Data_Cables.jpg" class="card-img-top" alt="Data Cables"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Data Cables</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Fast-charging and high-speed data transfer cables for all devices.
                            </p>
                            <a href="data_cables.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Customized_Gifts.jpg" class="card-img-top" alt="Customized Gifts"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Customized Gifts</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Fully customizable gift items tailor-made for personal and corporate events.
                            </p>
                            <a href="customized_gifts.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Corporate_Gifts.webp" class="card-img-top" alt="Corporate Gifts"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Corporate Gifts</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Premium corporate gifting solutions for clients and employees.
                            </p>
                            <a href="corporate_gifts.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Commercial_Displays.jpg" class="card-img-top" alt="Commercial Displays"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Commercial Displays</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Professional commercial display screens for advertising and branding.
                            </p>
                            <a href="commercial_displays.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/CCTV_Cameras.webp" class="card-img-top" alt="CCTV Cameras"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">CCTV Cameras</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                High-resolution CCTV cameras for home and business security.
                            </p>
                            <a href="cctv_cameras.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/CCTV_Accessories.jpg" class="card-img-top" alt="CCTV Accessories"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">CCTV Accessories</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Essential accessories including connectors, DVRs and installation equipment.
                            </p>
                            <a href="cctv_accessories.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0" style="transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <img src="assets/images/Battery_Chargers.webp" class="card-img-top" alt="Battery Chargers"
                            style="border-radius: 10px 10px 0 0;">
                        <div class="card-body text-center">
                            <h5 class="card-title" style="color: #0B5ED7;">Battery Chargers</h5>
                            <p class="card-text" style="color: #495057; font-size: 14px;">
                                Fast and reliable battery chargers for all mobile and electronic devices.
                            </p>
                            <a href="battery_chargers.php" class="btn"
                                style="background-color: #0B5ED7; color: #fff;">Details</a>
                        </div>
                    </div>
                </div>
    ...
    <section style="padding: 60px 0; background-color: #f8f9fa;">
        <div class="container">
            <!-- Section Heading -->
            <div class="text-center mb-5">
                <h2 style="color: #0B5ED7; font-weight: bold;">Our Services</h2>
                <p style="color: #6c757d; font-size: 18px;">
                    We offer a wide range of services to support our products and ensure customer satisfaction.
                </p>
            </div>
    ...
    <!-- FAQ Section -->
    <section style="padding: 60px 0; background-color: #e7f1ff;">
        <div class="container">
            <!-- Section Heading -->
            <div class="text-center mb-5">
                <h2 style="color: #0d6efd; font-weight: bold;">Frequently Asked Questions</h2>
                <p style="color: #6c757d; font-size: 18px;">
                    Have questions about RKM TECH SERV products? Find answers below.
                </p>
            </div>
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="faqHeading1">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            style="color: #0d6efd; background-color: #d0e4ff;">
                            What electronic devices do you offer?
                        </button>
                    </h2>
                    <div id="faq1" class="accordion-collapse collapse" aria-labelledby="faqHeading1"
                        ...
                        <div class="accordion-body" style="color: #6c757d;">
                            RKM TECH SERV provides a range of electronic devices including tablets, smart watches, and
                            other Makhana electronic products.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="faqHeading2">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            style="color: #0d6efd; background-color: #d0e4ff;">
                            Do you provide cables and connectivity solutions?
                        </button>
                    </h2>
                    <div id="faq2" class="accordion-collapse collapse" aria-labelledby="faqHeading2"
                        data-bs-parent="#faqAccordion">
                        <div class="accordion-body" style="color: #6c757d;">
                            Yes! We provide high-quality cables and connectivity solutions for smooth device operation
                            and performance.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="faqHeading3">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            style="color: #0d6efd; background-color: #d0e4ff;">
                            Are your batteries compatible with all devices?
                        </button>
                    </h2>
                    <div id="faq3" class="accordion-collapse collapse" aria-labelledby="faqHeading3"
                        data-bs-parent="#faqAccordion">
                        <div class="accordion-body" style="color: #6c757d;">
                            We provide batteries compatible with a wide range of devices including tablets, smart
                            watches, and other Makhana electronics.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="faqHeading4">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            style="color: #0d6efd; background-color: #d0e4ff;">
                            Do you offer repair services for tablets and watches?
                        </button>
                    </h2>
                    <div id="faq4" class="accordion-collapse collapse" aria-labelledby="faqHeading4"
                        data-bs-parent="#faqAccordion">
                        <div class="accordion-body" style="color: #6c757d;">
                            Yes! Our experts provide repair and troubleshooting services for tablets, smart watches, and
                            other Makhana devices.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="faqHeading5">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            style="color: #0d6efd; background-color: #d0e4ff;">
                            What warranty do you provide on products?
                        </button>
                    </h2>
                    <div id="faq5" class="accordion-collapse collapse" aria-labelledby="faqHeading5"
                        data-bs-parent="#faqAccordion">
                        <div class="accordion-body" style="color: #6c757d;">
                            All our products come with comprehensive warranty and product support to ensure customer
                            satisfaction.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="faq6" class="accordion-collapse collapse" aria-labelledby="faqHeading6"
                        data-bs-parent="#faqAccordion">
                        <div class="accordion-body" style="color: #6c757d;">
                            Absolutely! You can purchase multiple Makhana electronic devices, cables, batteries, and
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="faqHeading7">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            style="color: #0d6efd; background-color: #d0e4ff;">
                            Do you provide setup and installation services?
                        </button>
                    </h2>
                    <div id="faq7" class="accordion-collapse collapse" aria-labelledby="faqHeading7"
                        data-bs-parent="#faqAccordion">
                        <div class="accordion-body" style="color: #6c757d;">
                            Yes, we provide professional setup and installation services for smart watches, tablets, and
                            other devices.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="faq8" class="accordion-collapse collapse" aria-labelledby="faqHeading8"
                        data-bs-parent="#faqAccordion">
                        <div class="accordion-body" style="color: #6c757d;">
                            Delivery time depends on your location and the products purchased. Typically, it takes 3-7
                            business days for most areas.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="faq9" class="accordion-collapse collapse" aria-labelledby="faqHeading9"
                        data-bs-parent="#faqAccordion">
                        <div class="accordion-body" style="color: #6c757d;">
                            Yes! Our team provides full technical support for all RKM TECH SERV products including
                            tablets, watches, and batteries.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="faq10" class="accordion-collapse collapse" aria-labelledby="faqHeading10"
                        data-bs-parent="#faqAccordion">
                        <div class="accordion-body" style="color: #6c757d;">
                            Yes, RKM TECH SERV provides return and exchange options according to our company policy for
